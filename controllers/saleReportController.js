...
const generateSalesReport = async (req, res) => {
    try {
        console.log("re.query in generateSalesReport",req.query);
...
const generateSalesReportPDF = async (req, res) => {
    try {
        const { filter,startDate,endDate } = req.query;
        console.log("re.query in generateSalesReportPDF",req.query);

        const { salesData } = await generateSalesData(filter,null,null,startDate,endDate );
...
const generateSalesData = async (filter, page = 1, pageSize = 5,start, end) => {
    ...
    const totalRecords = totalSalesData[0]?.totalCount || 0;
